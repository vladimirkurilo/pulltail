...
<section class="section why-choose">
    <div class="choose-left">
        <img src="{{ URL::asset('/assets/img/bg/choose-left.png') }}" class="img-fluid" alt="Why Choose Us">
    </div>
    <div class="container">
        <!-- Heading title-->
                    ...
                    <div class="card flex-fill">
                        <div class="card-body">
                            <div class="choose-img choose-black">
                                <img src="{{ URL::asset('/assets/img/icons/bx-user-check.svg') }}" alt="">
                            </div>
                            <div class="choose-content">
                                <h4>Easy & Fast Booking</h4>
                                <p>Completely carinate e business testing process whereas fully researched customer
                                    service. Globally extensive content with quality.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card flex-fill">
                        <div class="card-body">
                            ...
                            <div class="choose-content">
                                ...
                                <p>Enthusiastically magnetic initiatives with cross-platform sources. Dynamically target
                                    testing procedures through effective.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card flex-fill">
                        <div class="card-body">
                            ...
                            <div class="choose-content">
                                ...
                                <p>Globally user centric method interactive. Seamlessly revolutionize unique portals
                                    corporate collaboration.</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<section class="section about-testimonial testimonials-section" style="background-image: none;
...
<!-- FAQ  -->
<section class="section faq-section bg-light-primary" style="display: none;">
    <div class="container">
        <!-- Heading title-->
        <div class="section-heading" data-aos="fade-down">
            ...
            <div class="faq-card bg-white" data-aos="fade-down">
                <h4 class="faq-title">
                    <a class="collapsed" data-bs-toggle="collapse" href="#faqSix" aria-expanded="false">eque
                        porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit?</a>
                </h4>
            ...
            <div class="faq-card bg-white" data-aos="fade-down">
                <h4 class="faq-title">
                    <a class="collapsed" data-bs-toggle="collapse" href="#faqSeven" aria-expanded="false">Nam
                        libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod?</a>
                </h4>
    ...
    <section class="pricing-section pricing-page pricing-section-bottom">
        <div class="container">
                ...
                <div class="col-lg-3 d-flex col-md-6 col-12" data-aos="fade-down">
                    <div class="price-card price-selected flex-fill">
                        ...
                        <div class="price-body">
                            <img class="img-fluid" src="{{ URL::asset('/assets/img/price-plan.png') }}"
                                alt="Price Plan">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="price-card flex-fill">
                        ...
                        <div class="price-details">
                            <ul>
                                ...
                                <li class="price-check"><span><i class="fa-regular fa-circle-check"></i></span>Rental
                                    car prices include tax</li>
                                <li class="price-uncheck"><span><i
                                            class="fa-regular fa-circle-xmark"></i></span>Extend
                                    or return anytime</li>
                                <li class="price-uncheck"><span><i
                                            class="fa-regular fa-circle-xmark"></i></span>Doorstep delivery in 2days
                                </li>
                    ...
                    <div class="price-card flex-fill">
                        ...
                        <div class="price-details">
                            <ul>
                                ...
                                <li class="price-check"><span><i class="fa-regular fa-circle-check"></i></span>Rental
                                    car prices include tax</li>
                                <li class="price-check"><span><i class="fa-regular fa-circle-check"></i></span>Extend
                                    or
                                    return anytime</li>
                                <li class="price-uncheck"><span><i
                                            class="fa-regular fa-circle-xmark"></i></span>Doorstep delivery in 2days
                            ...
                            <a href="{{ url('login') }}" class="btn viewdetails-btn btn-popular">Request a demo</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 d-flex col-md-6 col-12" data-aos="fade-down">
                        ...
                        <div class="price-details">
                            <ul>
                                ...
                                <li class="price-check"><span><i class="fa-regular fa-circle-check"></i></span>Extend
                                    or
                                    return anytime</li>
                                <li class="price-check"><span><i
                                            class="fa-regular fa-circle-check"></i></span>Doorstep
                                    delivery in 2days</li>
                                <li class="price-check"><span><i class="fa-regular fa-circle-check"></i></span>Car
                                    system included free of charge.</li>
                                <li class="price-check"><span><i class="fa-regular fa-circle-check"></i></span>Min 1
                                    month, extend anytime</li>
                            </ul>
            ...
            <div class="user-app-group">
                <div class="app-left">
                    <img src="{{ URL::asset('/assets/img/bg/app-left.png') }}" class="img-fluid"
                        alt="App Available">
                </div>
                <div class="app-right">
                    <img src="{{ URL::asset('/assets/img/bg/app-right.png') }}" class="img-fluid"
                        alt="App Available">
                </div>
                <div class="row">
                    <div class="col-lg-7">
                        <div class="userapp-heading">
                            ...
                            <p data-aos="fade-down">Appropriately monetize one-to-one interfaces rather than
                                cutting-edge
                                Competently disinte rmediate backward.</p>
                            <div class="download-btn">
                                <div class="app-avilable" data-aos="fade-down">
                                    <a href="javascript:void(0)"><img
                                            src="{{ URL::asset('/assets/img/play-store.svg') }}" alt="PlayStore"></a>
                                </div>
                                <div class="app-avilable" data-aos="fade-down">
                                    <a href="javascript:void(0)"><img src="{{ URL::asset('/assets/img/apple.svg') }}"
                                            alt="AppStore"></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-5 d-none d-lg-block">
                        <div class="car-holder">
                            <img class="app-car img-fluid" src="{{ URL::asset('/assets/img/app-car.png') }}"
                                alt="App Available" data-aos="fade-down">
                        </div>
                    </div>
                </div>
            </div>
