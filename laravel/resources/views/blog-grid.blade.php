                    ...
                    <div class="row">
                            ...
                            <div class="blog grid-blog">
                                ...
                                <div class="blog-content">
                                    ...
                                    <ul class="meta-item">
                                        ...
                                        <li class="date-icon"><i class="fa-solid fa-calendar-days"></i> <span>Jun 6,
                                                2023</span></li>
                                    </ul>
                                    <a href="{{ url('blog-details') }}" class="viewlink btn btn-primary">Read More <i
                        ...
                        <div class="col-lg-6 col-md-6 d-lg-flex">
                            <div class="blog grid-blog">
                                ...
                                <div class="blog-content">
                                    ...
                                    <h3 class="blog-title"><a href="{{ url('blog-details') }}">The 2023 Ford F-150 Raptor –
                                            A First Look</a></h3>
                                    <p class="blog-description">Everyone has the right to freedom of thought, conscience and
                                        religion; this right includes freedom to change his religion or belief, and freedom,
                                        either alone...</p>
                                    <ul class="meta-item">
                                        ...
                                        <li class="date-icon"><i class="fa-solid fa-calendar-days"></i> <span>Jun 1,
                                                2023</span></li>
                                    </ul>
                                    <a href="{{ url('blog-details') }}" class="viewlink btn btn-primary">Read More <i
                                            class="feather-arrow-right ms-2"></i></a>
                            ...
                            <div class="blog grid-blog">
                                ...
                                <div class="blog-content">
                                    ...
                                    <ul class="meta-item">
                                        ...
                                        <li class="date-icon"><i class="fa-solid fa-calendar-days"></i> <span>Apr 6,
                                                2023</span></li>
                                    </ul>
                                    <a href="{{ url('blog-details') }}" class="viewlink btn btn-primary">Read More <i
                                            class="feather-arrow-right ms-2"></i></a>
                            ...
                            <div class="blog grid-blog">
                                ...
                                <div class="blog-content">
                                    ...
                                    <ul class="meta-item">
                                        ...
                                        <li class="date-icon"><i class="fa-solid fa-calendar-days"></i> <span>Mar 28,
                                                2023</span></li>
                                    </ul>
                                    <a href="{{ url('blog-details') }}" class="viewlink btn btn-primary">Read More <i
                                            class="feather-arrow-right ms-2"></i></a>
                            ...
                            <div class="blog grid-blog">
                                ...
                                <div class="blog-content">
                                    ...
                                    <ul class="meta-item">
                                        ...
                                        <li class="date-icon"><i class="fa-solid fa-calendar-days"></i> <span>May 30,
                                                2023</span></li>
                                    </ul>
                                    <a href="{{ url('blog-details') }}" class="viewlink btn btn-primary">Read More <i
                                            class="feather-arrow-right ms-2"></i></a>
                        ...
                        <div class="col-lg-6 col-md-6 d-lg-flex">
                            <div class="blog grid-blog">
                                <div class="blog-image">
                                    <a href="{{ url('blog-details') }}"><img class="img-fluid"
                                            src="{{ URL::asset('/assets/img/blog/blog-6.jpg') }}" alt="Post Image"></a>
                                </div>
                                <div class="blog-content">
                                    <p class="blog-category">
                                        <a href="javascript:void(0)"><span>Car Showcase</span></a>
                                    ...
                                    <ul class="meta-item">
                                        ...
                                        <li class="date-icon"><i class="fa-solid fa-calendar-days"></i> <span>May 25,
                                                2023</span></li>
                                    </ul>
                                    <a href="{{ url('blog-details') }}" class="viewlink btn btn-primary">Read More <i
                                            class="feather-arrow-right ms-2"></i></a>
